...
![Simulation](images/Simulation.drawio.png)
...
Additionally, collectors  acquire and process environment data to create a full picture of the physical situation 
that our vehicle will be existing in, and the road conditions it will be traversing.

![Algorithm](images/Algorithm.drawio.png)
